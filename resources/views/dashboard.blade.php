...
<div class="space-y-6">
    ...
    <div class="glass-card rounded-2xl p-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <div class="mt-3">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-400/20 text-yellow-400 border border-yellow-400/30">
    ...
    <div class="glass-card rounded-2xl p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('pengajuanizin.addView') }}" class="group bg-gradient-to-br from-yellow-500/10 to-amber-500/10 border border-yellow-500/20 rounded-xl p-6 hover:from-yellow-500/20 hover:to-amber-500/20 transition-all duration-300 hover:scale-105">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h4 class="text-white font-semibold mb-2">Ajukan Izin</h4>
                    <p class="text-gray-400 text-sm">Buat pengajuan izin baru</p>
                </div>
            </a>

            <a href="{{ route('kronologi.addView') }}" class="group bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/20 rounded-xl p-6 hover:from-blue-500/20 hover:to-blue-600/20 transition-all duration-300 hover:scale-105">
                <div class="flex flex-col items-center text-center">
                    <div class="w-16 h-16 bg-blue-500/20 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-500/30 transition-colors">
                        <i class="fas fa-plus-square text-2xl text-blue-400"></i>
                    </div>
                    <h4 class="text-white font-semibold mb-2">Ajukan Kronologi</h4>
                    <p class="text-gray-400 text-sm">Buat pengajuan kronologi</p>
                </div>
            </a>

            <a href="{{ route('pengajuanizin.riwayat') }}" class="group bg-gradient-to-br from-green-500/10 to-green-600/10 border border-green-500/20 rounded-xl p-6 hover:from-green-500/20 hover:to-green-600/20 transition-all duration-300 hover:scale-105">
                <div class="flex flex-col items-center text-center">
            ...
            <a href="{{ route('staff.view') }}" class="group bg-gradient-to-br from-purple-500/10 to-purple-600/10 border border-purple-500/20 rounded-xl p-6 hover:from-purple-500/20 hover:to-purple-600/20 transition-all duration-300 hover:scale-105">
                <div class="flex flex-col items-center text-center">
