        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-3xl font-bold text-white mb-2">
                    📅 Rekap Absen Bulan <span class="text-yellow-400">{{ \Carbon\Carbon::parse($bulan)->translatedFormat('F Y') }}</span>
                </h2>
            ...
            <div class="bg-gradient-to-br from-yellow-500/10 to-amber-500/10 border border-yellow-500/20 rounded-xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white mt-1">{{ \Carbon\Carbon::parse($bulan)->format('m/Y') }}</p>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead class="bg-gray-800/30 rounded-lg">
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider sticky left-0 bg-gray-800/50 min-w-[200px] rounded-l-lg">
                                Nama Karyawan
                            </th>
                            @for ($i = 1; $i <= $jumlahHari; $i++)
                                <th class="px-3 py-3 text-center text-xs font-medium text-gray-400 uppercase tracking-wider min-w-[40px]">
                                    {{ $i }}
                                </th>
                            @endfor
                        </tr>
                    ...
                    <tbody class="space-y-2">
                        @foreach($staffList as $staff)
                            <tr class="bg-gray-800/30 rounded-lg border border-gray-700/50 hover:bg-gray-800/50 transition-colors duration-200">
                                <td class="px-4 py-4 whitespace-nowrap sticky left-0 bg-gray-800/50 backdrop-blur-sm rounded-l-lg">
            ...
            <div class="mt-8 p-6 bg-gray-800/30 rounded-lg border border-gray-700/50">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-green-500/20 text-green-400 border border-green-500/30">H</span>
                        <span class="text-white text-sm">Hadir</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-yellow-500/20 text-yellow-400 border border-yellow-500/30">S</span>
                        <span class="text-white text-sm">Sakit</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-blue-500/20 text-blue-400 border border-blue-500/30">I</span>
                        <span class="text-white text-sm">Izin</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-red-500/20 text-red-400 border border-red-500/30">A</span>
                        <span class="text-white text-sm">Alpha</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-purple-500/20 text-purple-400 border border-purple-500/30">T</span>
                        <span class="text-white text-sm">Terlambat</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-orange-500/20 text-orange-400 border border-orange-500/30">L</span>
                        <span class="text-white text-sm">Libur</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-gray-500/20 text-gray-400 border border-gray-500/30">-</span>
