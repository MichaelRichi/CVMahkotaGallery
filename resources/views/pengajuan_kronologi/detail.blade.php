...
<div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center p-4 bg-gray-800/30 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-green-400 font-semibold text-lg">Rp {{ number_format($pengajuan->harga_barang, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            @if(Auth::user()->role === 'admin')
                @if($pengajuan->validasi_admin === null)
                    @if($pengajuan->validasi_kepalacabang === 1)
                        <form action="{{ route('kronologi.validasi', $pengajuan->id) }}" method="POST" class="flex items-center space-x-4">
                            @csrf
    ...
    <div class="glass-card rounded-2xl p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center">
                <div class="w-4 h-4 {{ $pengajuan->validasi_kepalacabang !== null ? 'bg-green-500' : 'bg-gray-500' }} rounded-full mr-4"></div>
                <div class="flex-1">
